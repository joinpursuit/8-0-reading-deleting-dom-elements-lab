...
- [ok] Remove the "All Posts" link from the header.
- [ok] Remove the `span` element that contains the "Read Time" in the featured post. The featured post is the first post on the page.
- [ok] Remove the last post from the page, titled "Stop Planning".
- [ok] Remove all titles from all non-featured posts.
